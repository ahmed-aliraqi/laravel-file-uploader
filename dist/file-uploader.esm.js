...
/* template */
var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"form-group"},[_c('label',[_vm._v(_vm._s(_vm.label))]),_vm._v(" "),_c('div',{staticClass:"row uploader"},[_vm._l((_vm.files),function(file){return _c('div',{staticClass:"px-3"},[_c('div',{staticClass:"img-item mw-100 mb-4",attrs:{"title":file.file_name}},[_c('img',{staticClass:"mw-100",attrs:{"src":file.preview || 'https://cdn.jsdelivr.net/npm/laravel-file-uploader/dist/img/attach.png',"alt":""}}),_vm._v(" "),_c('a',{staticClass:"delete",attrs:{"href":"#","title":"Delete File"},on:{"click":function($event){$event.preventDefault();return _vm.deleteFile(file)}}},[_c('svg',{attrs:{"baseProfile":"tiny","height":"24px","id":"Layer_1","version":"1.2","viewBox":"0 0 22 30","width":"20px","xml:space":"preserve","xmlns":"http://www.w3.org/2000/svg","xmlns:xlink":"http://www.w3.org/1999/xlink"}},[_c('path',{attrs:{"fill":"#ffffff","d":"M17.414,6.586c-0.78-0.781-2.048-0.781-2.828,0L12,9.172L9.414,6.586c-0.78-0.781-2.048-0.781-2.828,0  c-0.781,0.781-0.781,2.047,0,2.828L9.171,12l-2.585,2.586c-0.781,0.781-0.781,2.047,0,2.828C6.976,17.805,7.488,18,8,18  s1.024-0.195,1.414-0.586L12,14.828l2.586,2.586C14.976,17.805,15.488,18,16,18s1.024-0.195,1.414-0.586  c0.781-0.781,0.781-2.047,0-2.828L14.829,12l2.585-2.586C18.195,8.633,18.195,7.367,17.414,6.586z"}})])]),_vm._v(" "),_c('span',{staticClass:"size"},[_vm._v(_vm._s(file.human_readable_size))])])])}),_vm._v(" "),_vm._l(((_vm.max - _vm.files.length < 0 ? 0 : _vm.max - _vm.files.length)),function(i){return _c('div',{staticClass:"px-3"},[_c('label',{staticClass:"img-item add mw-100 mb-4"},[_c('input',{ref:"file",refInFor:true,staticClass:"d-none",attrs:{"type":"file","accept":_vm.accept,"multiple":_vm.max > 1},on:{"change":_vm.readUrl}}),_vm._v(" "),(i <= _vm.pending)?_c('img',{staticClass:"mw-100",attrs:{"src":"https://cdn.jsdelivr.net/npm/laravel-file-uploader/dist/img/loading-100.gif","alt":""}}):_vm._e(),_vm._v(" "),_c('svg',{staticClass:"svg-inline--fa fa-plus-circle fa-w-16",attrs:{"aria-hidden":"true","focusable":"false","data-prefix":"fas","data-icon":"plus-circle","role":"img","xmlns":"http://www.w3.org/2000/svg","viewBox":"0 0 512 512"}},[_c('path',{attrs:{"fill":"gray","d":"M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm144 276c0 6.6-5.4 12-12 12h-92v92c0 6.6-5.4 12-12 12h-56c-6.6 0-12-5.4-12-12v-92h-92c-6.6 0-12-5.4-12-12v-56c0-6.6 5.4-12 12-12h92v-92c0-6.6 5.4-12 12-12h56c6.6 0 12 5.4 12 12v92h92c6.6 0 12 5.4 12 12v56z"}})])])])})],2),_vm._v(" "),_vm._l((_vm.values),function(token){return _c('input',{attrs:{"type":"hidden","name":"media[]"},domProps:{"value":token}})}),_vm._v(" "),_c('small',{staticClass:"text-muted"},[_vm._v(_vm._s(_vm.notes))])],2)};
var __vue_staticRenderFns__ = [];

  /* style */
  var __vue_inject_styles__ = function (inject) {
    if (!inject) { return }
    inject("data-v-c17b95ae_0", { source: ".mw-100[data-v-c17b95ae]{max-width:100%!important}.mb-4[data-v-c17b95ae]{margin-bottom:1.5rem!important}.px-3[data-v-c17b95ae]{padding-right:1rem!important}.px-3[data-v-c17b95ae]{padding-left:1rem!important}.text-muted[data-v-c17b95ae]{color:#6c757d!important}.uploader .img-item[data-v-c17b95ae]:not(.add){position:relative;text-align:center;border:2px dashed gray;border-radius:15px 0;overflow:hidden}.uploader .img-item:not(.add) img[data-v-c17b95ae]{text-align:center;max-width:100%}@media (min-width:992px){.uploader .img-item[data-v-c17b95ae]{width:140px}.uploader .img-item:not(.add) img[data-v-c17b95ae]{height:96px}}@media (min-width:768px) and (max-width:991.98px){.uploader .img-item[data-v-c17b95ae]{width:170px}.uploader .img-item:not(.add) img[data-v-c17b95ae]{height:126px}}@media (max-width:767.98px){.uploader .img-item:not(.add) img[data-v-c17b95ae]{height:96px}}.uploader .img-item:not(.add) a.delete[data-v-c17b95ae]{position:absolute;top:0;right:0;color:#fff!important;background:red;padding:1px;text-align:center;width:20px;height:20px;font-size:13px}.uploader .img-item:not(.add) .size[data-v-c17b95ae]{position:absolute;width:100%;left:0;bottom:0;background:#808080d6;border-radius:0 0 15px 0;color:#fff;font-weight:700}.uploader .add[data-v-c17b95ae]{cursor:pointer;border:2px dashed gray;border-radius:15px 0;display:flex;align-items:center}@media (min-width:992px){.uploader .add[data-v-c17b95ae]{height:100px;width:140px}}@media (min-width:768px) and (max-width:991.98px){.uploader .add[data-v-c17b95ae]{height:130px}}@media (max-width:767.98px){.uploader .add[data-v-c17b95ae]{height:100px;width:140px}}.uploader .add img[data-v-c17b95ae],.uploader .add svg[data-v-c17b95ae]{width:30%;margin:0 auto}", map: undefined, media: undefined });

  };
  /* scoped */
  var __vue_scope_id__ = "data-v-c17b95ae";
  /* module identifier */
